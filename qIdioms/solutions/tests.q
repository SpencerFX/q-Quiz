...
.solutions.tests.medium: (!) . flip raze 2 cut
    ...
    (`integerInterval;enlist 0010100b);
    (`intervalPairsClosedOpen;enlist 01001b);
    (`intervalPairsOpenClosed;enlist 10001b);
    (`adjacentDifference;enlist 1010011111b);
