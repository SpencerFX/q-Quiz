//====================================================================
//
// qIdiom - Finance - Question Functions
//
// Auto-generated from .inputs.finance.easy config.
// Each function prints the exercise header/description and the
// input for that idiom, pulled from .inputs.finance.easy.
//
//====================================================================

.qidiom.finance.presentValueCashFlows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Present Value Cash Flows";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.futureValueCashFlows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Future Value Cash Flows";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.compoundInterest:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Compound Interest";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.annuityCoefficient:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Annuity Coefficient";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.fifoStockDecrement:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Fifo Stock Decrement";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.paybackEndOfPeriod:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Payback End Of Period";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.paybackVariableRates:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Payback Variable Rates";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.paybackVariableRatesEndOfPeriod:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Payback Variable Rates End Of Period";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundNearestInteger:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Nearest Integer";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundNearestEvenInteger:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Nearest Even Integer";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundHalfToEven:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Half To Even";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundTwoDecimalPlaces:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Two Decimal Places";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundToNDecimals:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round To N Decimals";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundLargeNumberNDecimals:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Large Number N Decimals";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundNearestMultiple:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Nearest Multiple";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundNearestCurrencyMultiple:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Nearest Currency Multiple";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundSmallMagnitudesToZero:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Small Magnitudes To Zero";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundSummandsSet1:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Summands Set 1";
    -1 "======================================";
    -1 "";
...
.qidiom.finance.roundSummandsSet2:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Finance - Round Summands Set 2";
    -1 "======================================";
    -1 "";
