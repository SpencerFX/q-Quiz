//====================================================================
//
// qIdiom - Text - Question Functions
//
// Auto-generated from .inputs.text.easy/.medium/.hard config.
//
//====================================================================

.qidiom.text.leftJustifyFields:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Left Justify Fields";
    -1 "======================================";
    -1 "";
...
.qidiom.text.rightJustifyFields:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Right Justify Fields";
    -1 "======================================";
    -1 "";
...
.qidiom.text.collapseDuplicateCharacters:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Collapse Duplicate Characters";
    -1 "======================================";
    -1 "";
...
.qidiom.text.commaSeparatedList:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Comma Separated List";
    -1 "======================================";
    -1 "";
...
.qidiom.text.rowsStartingWith:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Rows Starting With";
    -1 "======================================";
    -1 "";
...
.qidiom.text.rowsDifferentFrom:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Rows Different From";
    -1 "======================================";
    -1 "";
...
.qidiom.text.frameCharacterMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Frame Character Matrix";
    -1 "======================================";
    -1 "";
...
.qidiom.text.insertStarsAfterEquals:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Insert Stars After Equals";
    -1 "======================================";
    -1 "";
...
.qidiom.text.matrixFromFlaggedParts:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Matrix From Flagged Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeDuplicateRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Duplicate Rows";
    -1 "======================================";
    -1 "";
...
.qidiom.text.collapseWhitespace:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Collapse Whitespace";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeBlankRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Blank Rows";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeLeadingBlankRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Leading Blank Rows";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeTrailingBlankRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Trailing Blank Rows";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeBlankColumns:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Blank Columns";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeLeadingBlankColumns:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Leading Blank Columns";
    -1 "======================================";
    -1 "";
...
.qidiom.text.removeTrailingBlankColumns:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Remove Trailing Blank Columns";
    -1 "======================================";
    -1 "";
...
.qidiom.text.appendEmptyRow:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Append Empty Row";
    -1 "======================================";
    -1 "";
...
.qidiom.text.insertEmptyRow:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Insert Empty Row";
    -1 "======================================";
    -1 "";
...
.qidiom.text.quotedCsvFromMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Quoted CSV From Matrix";
    -1 "======================================";
    -1 "";
    -1 "Trim, quote and join rows into CSV format, using input: .inputs.text.medium.quotedCsvFromMatrix";
    -1 "Input: ",-3!.inputs.text.medium`quotedCsvFromMatrix;
 };

.qidiom.text.collapseBlankRowsMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Collapse Blank Rows Matrix";
    -1 "======================================";
    -1 "";
    -1 "Collapse consecutive blank rows in a character matrix, using input: .inputs.text.medium.collapseBlankRowsMatrix";
    -1 "Input: ",-3!.inputs.text.medium`collapseBlankRowsMatrix;
 };

.qidiom.text.collapseBlankColumnsMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Collapse Blank Columns Matrix";
    -1 "======================================";
    -1 "";
    -1 "Collapse consecutive blank columns in a character matrix, using input: .inputs.text.medium.collapseBlankColumnsMatrix";
    -1 "Input: ",-3!.inputs.text.medium`collapseBlankColumnsMatrix;
 };

.qidiom.text.flaggedWordsToMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Flagged Words To Matrix";
    -1 "======================================";
    -1 "";
    -1 "Split flagged words into a padded character matrix, using input: .inputs.text.medium.flaggedWordsToMatrix";
    -1 "Input: ",-3!.inputs.text.medium`flaggedWordsToMatrix;
 };

.qidiom.text.insertStarsLarge:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Insert Stars Large";
    -1 "======================================";
    -1 "";
    -1 "Insert larger groups of '*' characters after '=' symbols, using input: .inputs.text.medium.insertStarsLarge";
    -1 "Input: ",-3!.inputs.text.medium`insertStarsLarge;
 };

//==================== Hard ====================

.qidiom.text.complexWhitespaceCleanup:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Complex Whitespace Cleanup";
    -1 "======================================";
    -1 "";
    -1 "Perform complex whitespace cleanup on a character matrix, using input: .inputs.text.hard.complexWhitespaceCleanup";
    -1 "Input: ",-3!.inputs.text.hard`complexWhitespaceCleanup;
 };

.qidiom.text.mixedAlignmentPipeline:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Mixed Alignment Pipeline";
    -1 "======================================";
    -1 "";
    -1 "Apply mixed field alignment to variable-width text, using input: .inputs.text.hard.mixedAlignmentPipeline";
    -1 "Input: ",-3!.inputs.text.hard`mixedAlignmentPipeline;
 };

.qidiom.text.largeDuplicateRowRemoval:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Large Duplicate Row Removal";
    -1 "======================================";
    -1 "";
    -1 "Remove duplicate rows from a larger text collection, using input: .inputs.text.hard.largeDuplicateRowRemoval";
    -1 "Input: ",-3!.inputs.text.hard`largeDuplicateRowRemoval;
 };

.qidiom.text.multipleInsertRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - Multiple Insert Rows";
    -1 "======================================";
    -1 "";
    -1 "Insert multiple empty rows into a character matrix, using input: .inputs.text.hard.multipleInsertRows";
    -1 "Input: ",-3!.inputs.text.hard`multipleInsertRows;
 };

.qidiom.text.csvQuotedTrimmed:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Text - CSV Quoted Trimmed";
    -1 "======================================";
    -1 "";
    -1 "Trim, quote and format text as CSV, using input: .inputs.text.hard.csvQuotedTrimmed";
    -1 "Input: ",-3!.inputs.text.hard`csvQuotedTrimmed;
 };