//====================================================================
//
// qIdiom - Parts & Items - Question Functions
//
// Auto-generated from .inputs.partsItems config.
//
//====================================================================

.qidiom.partsItems.vectorFromItems:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Vector From Items";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.itemsFromFlags:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Items From Flags";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.itemsFromLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Items From Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.startFlagsFromLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Start Flags From Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.endFlagsFromLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - End Flags From Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.startIndexesFromFlags:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Start Indexes From Flags";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.startIndexesFromLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Start Indexes From Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.endIndexesFromLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - End Indexes From Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.fieldStartIndexes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Field Start Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.fieldEndIndexes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Field End Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.lengthsFromStartIndexes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Lengths From Start Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.reverseEachPart:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Reverse Each Part";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.rotateEachPart:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Rotate Each Part";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.applyUniformFunction:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Apply Uniform Function";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.aggregateEachPart:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Aggregate Each Part";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.maximumsOfParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Maximums Of Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.sumsOfPartsByLengths:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Sums Of Parts By Lengths";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.sumsGroupedByCodes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Sums Grouped By Codes";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.sumsFlaggedByStarts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Sums Flagged By Starts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.runningSumsOfParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Running Sums Of Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.maximumSumOfParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Maximum Sum Of Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.findPartBeginningWith:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Find Part Beginning With";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.equalItemPartStarts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Equal Item Part Starts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.equalItemPartEnds:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Equal Item Part Ends";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.runningParityOfParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Running Parity Of Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.groupsOfOnes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Groups Of Ones";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.insertZerosAfterParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Insert Zeros After Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.orScanParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - OR Scan Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.andScanParts:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - AND Scan Parts";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.gthPart:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - g-th Part";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.insertAfterEachItem:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Insert After Each Item";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.appendItemsToEach:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Append Items To Each";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.prependItemsToEach:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Prepend Items To Each";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.insertAfterIndexes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Insert After Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.partsItems.insertCopiesBeforeIndexes:{
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Parts & Items - Insert Copies Before Indexes";
    -1 "======================================";
    -1 "";
