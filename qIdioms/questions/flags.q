...
//====================================================================
//
// qIdiom - Flags - Question Functions
//
// Auto-generated from .inputs.flags.easy config.
//
//====================================================================
//

.qidiom.flags.invertZerosAfterFirstOne:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert Zeros After First One";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.invertOnesAfterFirstOne:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert Ones After First One";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.invertZerosAfterFirstZero:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert Zeros After First Zero";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.invertOnesAfterFirstZero:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert Ones After First Zero";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.smearOnesBetweenPairs:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Smear Ones Between Pairs";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.invertFieldsBetweenPairs:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert Fields Between Pairs";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.invertAllButFirstInGroup:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Invert All But First In Group";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.insertZeroAfterIndexes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Insert Zero After Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.flagsAtIndexes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Flags At Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.vectorLengthOnesAtIndexes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Vector Length Ones At Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.vectorLengthZerosAtIndexes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Vector Length Zeros At Indexes";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.onesFollowedByZeros:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Ones Followed By Zeros";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.zerosFollowedByOnes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Zeros Followed By Ones";
    -1 "======================================";
    -1 "";
...
//====================================================================
//
// qIdiom - Flags - Question Functions (Part 2A)
//
// Auto-generated from .inputs.flags.easy config.
//
//====================================================================
...
.qidiom.flags.onesPrecededByZeros:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Ones Preceded By Zeros";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.zerosPrecededByOnes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Zeros Preceded By Ones";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.flagPositiveIntegers:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Flag Positive Integers";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.lengthsOfGroupsOfOnes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Lengths Of Groups Of Ones";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.firstOneAfterIndex:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - First One After Index";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.allFlagsMixed:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - All Flags Mixed";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.allFlagsAllOnes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - All Flags All Ones";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.allFlagsAllZeros:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - All Flags All Zeros";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.anyFlagsFalse:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Any Flags False";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.noneFlagsTrue:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - None Flags True";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.noneFlagsMixed:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - None Flags Mixed";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.kroneckerDelta:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Kronecker Delta";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.firstGroupOfOnes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - First Group Of Ones";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.firstOnesInGroups:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - First Ones In Groups";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.lastOnesInGroups:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Last Ones In Groups";
    -1 "======================================";
    -1 "";
...
.qidiom.flags.selectItemsFlagged:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Flags - Select Items Flagged";
    -1 "======================================";
    -1 "";
