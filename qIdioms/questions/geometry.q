...
//====================================================================
//
// qIdiom - Geometry - Question Functions
//
// Auto-generated from .inputs.geometry.easy config.
//
//====================================================================
//

.qidiom.geometry.degreesFromDegreesAndMinutes:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Degrees From Degrees And Minutes";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.degreesFromRadians:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Degrees From Radians";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.radiansFromDegrees:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Radians From Degrees";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.nauticalMilesFromRadians:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Nautical Miles From Radians";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.greatCircleDistance:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Great Circle Distance";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.areaOfTriangleWithSides:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Area Of Triangle With Sides";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.complementaryAngle:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Complementary Angle";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.rotationMatrixCounterClockwise:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Rotation Matrix Counter Clockwise";
    -1 "======================================";
    -1 "";
...
.qidiom.geometry.contourLevels:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Geometry - Contour Levels";
    -1 "======================================";
    -1 "";
