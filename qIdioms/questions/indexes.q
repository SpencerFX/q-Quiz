...
//====================================================================
//
// qIdiom - Indexes - Question Functions
//
// Auto-generated from .inputs.indexes.easy config.
//
//====================================================================
//

.qidiom.indexes.allIndexesOfVector:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - All Indexes Of Vector";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.yWideSublists:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Y Wide Sublists";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.sublistsOfLengthStartingAt:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Sublists Of Length Starting At";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.allPairsOfTil:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - All Pairs Of Til";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.indexesOfArray:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Indexes Of Array";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.scatteredIndexing:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Scattered Indexing";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.raveledIndexFromGeneralIndex:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Raveled Index From General Index";
    -1 "======================================";
    -1 "";
...
.qidiom.indexes.indexArbitraryRankArray:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Indexes - Index Arbitrary Rank Array";
    -1 "======================================";
    -1 "";
