//====================================================================
//
// qIdiom - Arithmetic - Question Functions
//
// Auto-generated from .inputs.arithmetic.easy config.
// Each function prints the exercise header/description and the
// input for that idiom, pulled from .inputs.arithmetic.easy.
//
//====================================================================

.qidiom.arithmetic.sumAVector:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum A Vector";
    -1 "======================================";
    -1 "";
    -1 "Sum a vector using input: .inputs.arithmetic.easy.sumAVector";
    -1 "Input: ", -3!.inputs.arithmetic.easy`sumAVector;
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumAVector
 };
...
.qidiom.arithmetic.sumColumnsMatrix:{[]
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumColumnsMatrix
 };

.qidiom.arithmetic.sumRowsMatrix:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum Rows Matrix";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumRowsMatrix
 };

.qidiom.arithmetic.sumItemsGrouped:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum Items Grouped";
    -1 "======================================";
    -1 "";
    -1 "Sum items in groups using input: .inputs.arithmetic.easy.sumItemsGrouped";
    -1 "Input: ", -3!.inputs.arithmetic.easy`sumItemsGrouped;
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumItemsGrouped
 };

.qidiom.arithmetic.addVectorToRows:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Add Vector To Rows";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`addVectorToRows
 };

.qidiom.arithmetic.addVectorToColumns:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Add Vector To Columns";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`addVectorToColumns
 };

.qidiom.arithmetic.addToLastItem:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Add To Last Item";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`addToLastItem
 };

.qidiom.arithmetic.sumReciprocalSeries:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum Reciprocal Series";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumReciprocalSeries
 };

.qidiom.arithmetic.sumOverSubsets:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum Over Subsets";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumOverSubsets
 };

.qidiom.arithmetic.sumSquares:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Sum Squares";
    -1 "======================================";
    -1 "";
    -1 "Sum the squares of a vector using input: .inputs.arithmetic.easy.sumSquares";
    -1 "Input: ", -3!.inputs.arithmetic.easy`sumSquares;
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`sumSquares
 };

.qidiom.arithmetic.alternatingSum:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Alternating Sum";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`alternatingSum
 };

.qidiom.arithmetic.alternatingSumSeries:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Alternating Sum Series";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`alternatingSumSeries
 };

.qidiom.arithmetic.increaseAbsoluteValueWithoutSignChange:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Increase Absolute Value Without Sign Change";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`increaseAbsoluteValueWithoutSignChange
 };

.qidiom.arithmetic.vectorNegative:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Vector Negative";
    -1 "======================================";
    -1 "";
    -1 "Negate a vector using input: .inputs.arithmetic.easy.vectorNegative";
    -1 "Input: ", -3!.inputs.arithmetic.easy`vectorNegative;
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`vectorNegative
 };

.qidiom.arithmetic.numericArrayNegative:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Numeric Array Negative";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`numericArrayNegative
 };

.qidiom.arithmetic.firstDifference:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - First Difference";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`firstDifference
 };

.qidiom.arithmetic.pairwiseDifference:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Pairwise Difference";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`pairwiseDifference
 };

.qidiom.arithmetic.zeroArray:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Zero Array";
    -1 "======================================";
    -1 "";
...
.qidiom.arithmetic.multiplicationTable:{[]
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`multiplicationTable
 };

.qidiom.arithmetic.squareRetainingSign:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Square Retaining Sign";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`squareRetainingSign
 };

.qidiom.arithmetic.multiplyEachColumn:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Multiply Each Column";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`multiplyEachColumn
 };

.qidiom.arithmetic.multiplyEachRow:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Multiply Each Row";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`multiplyEachRow
 };

.qidiom.arithmetic.vectorCrossProduct:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Vector Cross Product";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`vectorCrossProduct
 };

.qidiom.arithmetic.alternatingProduct:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Alternating Product";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`alternatingProduct
 };

.qidiom.arithmetic.directMatrixProduct:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Direct Matrix Product";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`directMatrixProduct
 };

.qidiom.arithmetic.matrixProduct:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Matrix Product";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`matrixProduct
 };

.qidiom.arithmetic.dotProduct:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Dot Product";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`dotProduct
 };

.qidiom.arithmetic.productOverSubsets:{[]
    -1 "";
    -1 "======================================";
    -1 " qIdiom - Arithmetic - Product Over Subsets";
    -1 "======================================";
    -1 "";
    ...
    /-1 "Expected Output: ", -3!.solution.arithmetic.easy`productOverSubsets
 };
