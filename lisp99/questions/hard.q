...
.fundamental.lisp99.flattenNested:{[]
    -1 "";
    -1 "======================================";
    -1 " Fundamentals - Lisp-99 - Flatten (P07)";
    -1 "======================================";
    -1 "";
...
.fundamental.lisp99.packConsecutive:{[]
    -1 "";
    -1 "======================================";
    -1 " Fundamentals - Lisp-99 - Pack (P09)";
    -1 "======================================";
    -1 "";
...
.fundamental.lisp99.runLengthEncode:{[]
    -1 "";
    -1 "======================================";
    -1 " Fundamentals - Lisp-99 - Run-Length Encode (P10)";
    -1 "======================================";
    -1 "";
